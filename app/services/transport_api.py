...
EXTERNAL_TRANSITO_SEMAFOROS_PATH = "/transito/v1/semaforos"
...
async def fetch_semaforos() -> Any:
    ...
    url = f"{settings.transporte_base_url.rstrip('/')}{EXTERNAL_TRANSITO_SEMAFOROS_PATH}"
    timeout = httpx.Timeout(10.0, connect=5.0)
